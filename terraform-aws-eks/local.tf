locals {
  ...
  workers_group_defaults_defaults = {
    ...
    tags                          = [{key: "project", value: "eks-main", propagate_at_launch: true}]                          # A list of map defining extra tags to be applied to the worker group autoscaling group.
    ...
    iam_instance_profile_name     = "eks-main-ap-northeast-2-role"                          # A custom IAM instance profile name. Used when manage_worker_iam_resources is set to false. Incompatible with iam_role_id.
